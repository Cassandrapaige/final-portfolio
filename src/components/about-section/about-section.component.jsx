...
import Sparkles from '../sparkles/sparkles.component'
    ...
    return (
        <AboutContainer> 
            <Title>About Me</Title>
                ...
                <Text>
                    It wasn't until I discovered the world of tech that I found something I truly love. I'll never forget how excited I was the first time I wrote '99 bottles of beer on the wall' with only 3 lines of code. <Sparkles>Like magic.</Sparkles>
                </Text>
                <Text>
